...
- Added `pipedrive-deal-ops` and `pipedrive-contact-ops` skills for common Pipedrive CRM workflows.

## 0.1.2 - 2026-03-06

- Added `vercel-operations` skill for common Vercel MCP workflows (projects, deployments, logs, domains).
