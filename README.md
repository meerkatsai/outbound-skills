...
- `skills/`: agent skills (`SKILL.md`) and supporting references
  - Current skills: `apollo-outbound`, `competitor-alternatives`, `email-find-verify`, `pipedrive-crm`, `product-marketing-context`, `rb2b-integration`, `resend-email`, `smartlead-outbound`, `trigify-integration`, `vercel-integration`, `web-search-scrape`
