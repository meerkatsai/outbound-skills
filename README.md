...
- `skills/`: agent skills (`SKILL.md`) and supporting references
  - Current skills: `apollo-outbound`, `competitor-alternatives`, `email-find-verify`, `pipedrive-crm`, `product-marketing-context`, `resend-email`, `smartlead-outbound`, `vercel-integration`, `web-search-scrape`
